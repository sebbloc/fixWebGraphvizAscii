 ...
 *
 * http://pegjs.org/
 * manualy modified by Sébastien Bloc for project fixVisAscii
 */
...
function peg$parse(input, options) {
  ...
  function peg$parseHTML_STRING() {
    ...
    s0 = s1;
/*
	// memodraw: remove multi-line
	if (s0.value) {
		//console.log("html", s0.value);
		s0.value = s0.value.replace(/\n/g,"");
	}
*/
    return s0;
  }
...
*/
var dotParse = peg$parse;// serialize from DOT data parsing
...
var dotParse = peg$parse;// Graphviz tools 
// (c) 2021 Sébastien Bloc [sbloc@hotmail.com]
// released under the MIT license
